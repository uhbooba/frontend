  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className=''>
          <p className='mt-2 text-lg font-bold text-start ml-4'>
            매달 일정 금액을 정해진 기간 동안 저축하고, <br />
            만기시 원금과 이자를 받는 금융상품입니다.
          </p>

          <p className='mt-4 text-start ml-4 text-lg font-bold'>
            적금은 매월 혹은 <span className='text-yellow-400 font-bold'>일정 주기</span>마다  
            <span className='text-yellow-400 font-bold'> 일정 금액</span>을 <br/>
            <span className='text-yellow-400 font-bold'> 저축</span>해야 합니다.
          </p>
          ...
          <p className='mt-4 text-start ml-4 text-lg font-bold'>
            <span className='text-yellow-400 font-bold'>목돈을 마련</span>하고 싶을 때 추천하는 상품입니다.
          </p>
       ...
       {/* 말풍선 부분 */}
       <div className="relative mt-8 ml-16 w-[255px] z-10">
          <div className="relative p-3 rounded-lg bg-gray-100 border-2 border-gray-300">
            <p className="text-lg text-center text-black">매달 열심히 적금을 하면</p>
            <p className="text-lg text-center text-black">나중에 목돈이 될거야!</p>

            {/* 말풍선 꼬리 부분 */}
            <div className="absolute bottom-[-22px] left-[80%] transform -translate-x-1/2">
              {/* 바깥쪽 삼각형*/}

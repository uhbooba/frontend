...
import { accountHolderNameAtomn, accountNumberAtom, amountAtom, myAccountRecordAtom, selectedBankAtom, yourAccountRecordAtom } from '@/atoms/account/accountTransferAtoms';
...
const AccountTransferDepositName = () => {
    ...
    const [yourAccountRecord, setYourAcoountRecord] = useAtom(yourAccountRecordAtom)

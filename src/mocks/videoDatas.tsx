const videoDatas = [
  {
    ...
    keyword: '시.금.치',
    title:
      '시니어들의 모바일 금융을 코치해드립니다 - ep.3 계좌정보통합관리 활용법',
    url: 'https://www.youtube.com/embed/k8tPGl0b8Mw?si=iIki0SdHnoEz-da9?nocache=1&rel=0',
    description:
      '나도 모르고 있던 계좌를 찾아드립니다\r구석구석 숨겨져 있던 은행계좌,증권 등\r조회 한번으로 모두 볼 수 있다',
  ...
  },
  {
    ...
    description:
      '이제는 어플 하나로 \r은행업무를 모두 해결 할 수 있다?!\r시간절약! 체력절약!\r한 곳에서 모두 처리 할 수 있는 오픈뱅킹',
  ...
  },
  {
    ...
    description:
      '어플 설치부터 은행업무까지\r \r모바일 뱅킹에 익숙하지 않은\r시니어들을 위한 모바일뱅킹 활용법',
